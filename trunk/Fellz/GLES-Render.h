...
// node to be used on debug drawning
// holds a GLESDebugDraw object
class Box2DDebugDraw : public cocos2d::CCNode
{
public:
	// create method, copied from CCNode class
	static Box2DDebugDraw* create(b2World* world);
	// contructor
	Box2DDebugDraw(b2World* world);
	// dealloc
	virtual ~Box2DDebugDraw();
	// to draw debug stuff
	void draw();
private:
	GLESDebugDraw* debugDrawning;
	b2World* world; // local instance of box2d world
};
